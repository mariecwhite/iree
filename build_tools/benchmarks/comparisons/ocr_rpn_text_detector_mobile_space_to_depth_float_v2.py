...
class TfliteRpnTextDetectorMobileSpaceToDepthFloatV2(TFLiteBenchmarkCommand):
...
class IreeRpnTextDetectorMobileSpaceToDepthFloatV2(IreeBenchmarkCommand):
  ...
  def __init__(self, benchmark_binary: str, model_name: str, model_path: str,
    ...
    self.args.append("--function_input=\"1x256x256x1xf32=0\"")


class RpnTextDetectorMobileSpaceToDepthFloatV2Factory(BenchmarkCommandFactory):
