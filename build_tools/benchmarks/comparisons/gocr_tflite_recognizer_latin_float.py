...
class TfliteGocrTfliteRecognizerLatinFloat(TFLiteBenchmarkCommand):
  ...
  def __init__(self, benchmark_binary: str, model_name: str, model_path: str,
    ...
    super().__init__(benchmark_binary, model_name, model_path, num_threads,
                     ...
                     taskset=taskset)
    self.driver = driver
    self.args.append("--input_layer=ExpandDims")
    self.args.append("--input_layer_shape=1,124,24,1")


class IreeGocrTfliteRecognizerLatinFloat(IreeBenchmarkCommand):
  ...
  def __init__(self, benchmark_binary: str, model_name: str, model_path: str,
    ...
    self.args.append("--function_input=\"1x124x24x1xf32=0\"")


class GocrTfliteRecognizerLatinFloatFactory(BenchmarkCommandFactory):
  """ Generates `BenchmarkCommand` objects specific to running MobileBert."""

  def __init__(self, base_dir: str):
    self._model_name = "rpn_text_detector_mobile_space_to_depth_float_v2"
  ...
  def _generate_cpu(self):
    ...
    tflite_model = TfliteRpnTextDetectorMobileSpaceToDepthFloatV2(self._tflite_benchmark_binary_path,
                                             self._model_name,
    ...
    iree_model = IreeRpnTextDetectorMobileSpaceToDepthFloatV2(self._iree_benchmark_binary_path,
                                         self._model_name,
    ...
    iree_mmt4d_model = IreeRpnTextDetectorMobileSpaceToDepthFloatV2(self._iree_benchmark_binary_path,
                                               model_mmt4d_name,
