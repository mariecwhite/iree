...
class TfliteRpnTextDetectorMobileSpaceToDepthQuantizedV2(TFLiteBenchmarkCommand):
...
class IreeRpnTextDetectorMobileSpaceToDepthQuantizedV2(IreeBenchmarkCommand):
...
class RpnTextDetectorMobileSpaceToDepthQuantizedV2Factory(BenchmarkCommandFactory):
  """ Generates `BenchmarkCommand` objects specific to running MobileBert."""

  def __init__(self, base_dir: str):
    self._model_name = "rpn_text_detector_mobile_space_to_depth_quantized_v2"
  ...
  def _generate_cpu(self):
    ...
    tflite_model = TfliteRpnTextDetectorMobileSpaceToDepthQuantizedV2(self._tflite_benchmark_binary_path,
                                             self._model_name,
    ...
    iree_model = IreeRpnTextDetectorMobileSpaceToDepthQuantizedV2(self._iree_benchmark_binary_path,
                                         self._model_name,
    ...
    iree_mmt4d_model = IreeRpnTextDetectorMobileSpaceToDepthQuantizedV2(self._iree_benchmark_binary_path,
                                               model_mmt4d_name,
