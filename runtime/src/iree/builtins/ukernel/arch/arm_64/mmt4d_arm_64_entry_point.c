...
static iree_uk_mmt4d_tile_func_t
iree_uk_mmt4d_select_tile_func_arm_64_i8i4i32_M0x16x2(
    const iree_uk_mmt4d_params_t* params) {
  switch (params->M0) {
    case 1:
      return iree_uk_mmt4d_tile_s8s4s32_1x16x2_arm_64;
    case 2:
      return iree_uk_mmt4d_tile_s8s4s32_2x16x2_arm_64;
    case 4:
      return iree_uk_mmt4d_tile_s8s4s32_4x16x2_arm_64;
  }
  return 0;
}
...
static iree_uk_mmt4d_tile_func_t
iree_uk_mmt4d_select_tile_func_arm_64_i8i4i32_M0x16x16(
    const iree_uk_mmt4d_params_t* params) {
#ifdef IREE_UK_BUILD_ARM_64_I8MM
  if (iree_uk_cpu_supports_i8mm(params->cpu_data)) {
    switch (params->M0) {
      case 1:
        return iree_uk_mmt4d_tile_s8s4s32_1x16x16_arm_64_i8mm;
    }
  }
#endif
  return 0;
...
//static iree_uk_mmt4d_tile_func_t
//iree_uk_mmt4d_select_tile_func_arm_64_i8i4i32_M0x4x16(
//    const iree_uk_mmt4d_params_t* params) {
//#ifdef IREE_UK_BUILD_ARM_64_I8MM
//  if (iree_uk_cpu_supports_i8mm(params->cpu_data)) {
//    switch (params->M0) {
//      case 1:
//        return iree_uk_mmt4d_tile_s8s4s32_1x4x16_arm_64_i8mm;
//    }
//  }
//#endif
//  return 0;
...
//  }
  if (params->K0 == 16) {
    if (params->M0 == 1) {
      if (params->N0 == 16) {
        return iree_uk_mmt4d_select_tile_func_arm_64_i8i4i32_M0x16x16(params);
      }
//      if (params->N0 == 8) {
//        return iree_uk_mmt4d_select_tile_func_arm_64_i8i4i32_M0x8x16(params);
//      }
//      if (params->N0 == 4) {
//        return iree_uk_mmt4d_select_tile_func_arm_64_i8i4i32_M0x4x16(params);
//      }
    } else if (params->N0 == 8) {
      return iree_uk_mmt4d_select_tile_func_arm_64_i8i4i32_M0x8x16(params);
    }
...
iree_uk_mmt4d_tile_func_t iree_uk_mmt4d_select_tile_func_arch(
  ...
  switch (iree_uk_mmt4d_type(params->flags)) {
    ...
    case iree_uk_mmt4d_type_s8s4s32:
      return iree_uk_mmt4d_select_tile_func_arm_64_i8i4i32(params);
    default:
      return 0;
  }
}
