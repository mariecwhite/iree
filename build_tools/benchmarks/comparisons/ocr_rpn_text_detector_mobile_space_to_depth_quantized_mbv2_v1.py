...
class TfliteRpnTextDetectorMobileSpaceToDepthQuantizedMbv2V1(TFLiteBenchmarkCommand):
  ...
  def __init__(self, benchmark_binary: str, model_name: str, model_path: str,
    ...
    self.args.append("--input_layer_shape=1,256,256,1")


class IreeRpnTextDetectorMobileSpaceToDepthQuantizedMbv2V1(IreeBenchmarkCommand):
  ...
  def __init__(self, benchmark_binary: str, model_name: str, model_path: str,
    ...
    self.args.append("--function_input=\"1x256x256x1xui8=0\"")


class RpnTextDetectorMobileSpaceToDepthQuantizedMbv2V1Factory(BenchmarkCommandFactory):
  """ Generates `BenchmarkCommand` objects specific to running MobileBert."""

  def __init__(self, base_dir: str):
    self._model_name = "rpn_text_detector_mobile_space_to_depth_quantized_mbv2_v1"
  ...
  def _generate_cpu(self):
    ...
    tflite_model = TfliteRpnTextDetectorMobileSpaceToDepthQuantizedMbv2V1(self._tflite_benchmark_binary_path,
                                             self._model_name,
    ...
    iree_model = IreeRpnTextDetectorMobileSpaceToDepthQuantizedMbv2V1(self._iree_benchmark_binary_path,
                                         self._model_name,
    ...
    iree_mmt4d_model = IreeRpnTextDetectorMobileSpaceToDepthQuantizedMbv2V1(self._iree_benchmark_binary_path,
                                               model_mmt4d_name,
