...
class TfliteTfliteLstmRecognizerLatin03ConvModel(TFLiteBenchmarkCommand):
  ...
  def __init__(self, benchmark_binary: str, model_name: str, model_path: str,
    ...
    self.args.append("--input_layer_shape=1,112,24,1")


class IreeTfliteLstmRecognizerLatin03ConvModel(IreeBenchmarkCommand):
  ...
  def __init__(self, benchmark_binary: str, model_name: str, model_path: str,
    ...
    self.args.append("--function_input=\"1x112x24x1xui8=0\"")


class TfliteLstmRecognizerLatin03ConvModelFactory(BenchmarkCommandFactory):
  """ Generates `BenchmarkCommand` objects specific to running MobileBert."""

  def __init__(self, base_dir: str):
    self._model_name = "tflite_lstm_recognizer_latin_0.3.conv_model"
  ...
  def _generate_cpu(self):
    ...
    tflite_model = TfliteTfliteLstmRecognizerLatin03ConvModel(self._tflite_benchmark_binary_path,
                                             self._model_name,
    ...
    iree_model = IreeTfliteLstmRecognizerLatin03ConvModel(self._iree_benchmark_binary_path,
                                         self._model_name,
    ...
    iree_mmt4d_model = IreeTfliteLstmRecognizerLatin03ConvModel(self._iree_benchmark_binary_path,
                                               model_mmt4d_name,
