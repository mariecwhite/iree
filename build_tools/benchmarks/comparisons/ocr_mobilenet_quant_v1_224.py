...
class TfliteMobilenetQuantV1224(TFLiteBenchmarkCommand):
  ...
  def __init__(self, benchmark_binary: str, model_name: str, model_path: str,
    ...
    super().__init__(benchmark_binary, model_name, model_path, num_threads,
                     ...
                     taskset=taskset)
    self.driver = driver
    self.args.append("--input_layer=Placeholder")
    self.args.append("--input_layer_shape=1,224,224,3")


class IreeMobilenetQuantV1224(IreeBenchmarkCommand):
  ...
  def __init__(self, benchmark_binary: str, model_name: str, model_path: str,
    ...
    self.args.append("--function_input=\"1x224x224x3xui8=0\"")


class MobilenetQuantV1224Factory(BenchmarkCommandFactory):
  """ Generates `BenchmarkCommand` objects specific to running MobileBert."""

  def __init__(self, base_dir: str):
    self._model_name = "mobilenet_quant_v1_224"
  ...
  def _generate_cpu(self):
    ...
    tflite_model = TfliteMobilenetQuantV1224(self._tflite_benchmark_binary_path,
                                             self._model_name,
    ...
    iree_model = IreeMobilenetQuantV1224(self._iree_benchmark_binary_path,
                                         self._model_name,
    ...
    iree_mmt4d_model = IreeMobilenetQuantV1224(self._iree_benchmark_binary_path,
                                               model_mmt4d_name,
